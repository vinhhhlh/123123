...
#----roblox delta
    if tab <=5 and not(cfe("/sdcard/Download/delta.zip")):
        ...
        wget.download("https://www.mediafire.com/file/d4qhdu2p4ve5877/delta.zip/file",out="delta.zip")
        
    elif tab > 5 and not(cfe("/sdcard/Download/deltasvip.zip")):
        print("Download delta(large).zip")
        wget.download("https://www.mediafire.com/file/d4qhdu2p4ve5877/delta.zip/file",out="deltasvip.zip")

...
TextLabel.Text = "Apsara Hub Kaitun / Cuttay"
...
TextLabel1.Text = "Kaitun Beta Script"
...
ImageLabel.Image = "rbxassetid://17556296872"
...
script_time = os.time()
if not isfolder(".aps/BloxFruit/Kaitun/") then
               makefolder(".aps/BloxFruit/Kaitun/")
end
   ...
   local badtimedicac = os.time()
         if not isfile(".aps/BloxFruit/Kaitun/eslapedtime."..game.Players.LocalPlayer.Name) then
        
         writefile(".aps/BloxFruit/Kaitun/eslapedtime."..game.Players.LocalPlayer.Name, "0")
         esltime = 0 
         end 
   ctent2 = readfile(".aps/BloxFruit/Kaitun/eslapedtime."..game.Players.LocalPlayer.Name)
   function updatetime()
      if not isfile(".aps/BloxFruit/Kaitun/eslapedtime."..game.Players.LocalPlayer.Name) then
         ...
         ctent = readfile(".aps/BloxFruit/Kaitun/eslapedtime."..game.Players.LocalPlayer.Name)
         if tonumber(ctent) or ctent == "0" or ctent == "1" then
            esltime = tonumber(ctent2 or 0) + (os.time()-(badtimedicac or os.time()))
            writefile(".aps/BloxFruit/Kaitun/eslapedtime."..game.Players.LocalPlayer.Name, tostring(esltime))
...
local Window = Library:CreateWindow({
    ...
    Title = 'Apsara Community '..os.date("%d".." ".."%B".." ".."%Y"),
...
local Tabs = {
    Main = Window:AddTab('U Need To Touch Grass Bro...'), 
} 
...
Info:AddLabel("Apsara Community Kaitun") 
